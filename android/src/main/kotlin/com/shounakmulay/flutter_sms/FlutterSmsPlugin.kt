...
import com.shounakmulay.flutter_sms.sms.SmsController
import com.shounakmulay.flutter_sms.sms.SmsQueryMethodCallHandler
import com.shounakmulay.flutter_sms.sms.SmsSendStreamHandler
import com.shounakmulay.flutter_sms.sms.SmsSendMethodCallHandler
...
import com.shounakmulay.flutter_sms.utils.Constants.STREAM_CHANNEL_SEND_SMS
...
class FlutterSmsPlugin : FlutterPlugin, ActivityAware {
  ...
  private fun setupPlugin(context: Context, messenger: BinaryMessenger) {
    ...
    smsSendEventChannel = EventChannel(messenger, STREAM_CHANNEL_SEND_SMS)
